...
Namespace Xeora.Web.Controller.Directive.Control
    Public Class RadioButton
        ...
        Public Sub New(ByVal DraftStartIndex As Integer, ByVal DraftValue As String, ByVal ContentArguments As [Global].ArgumentInfo.ArgumentInfoCollection)
            MyBase.New(DraftStartIndex, DraftValue, ControlTypes.RadioButton, ContentArguments)
        ...
        Public Overrides Sub Clone(ByRef Control As IControl)
            Control = New RadioButton(Me.DraftStartIndex, Me.DraftValue, Me.ContentArguments)
            MyBase.Clone(Control)

            With CType(Control, RadioButton)
        ...
        Private Sub RenderInternal()
            ...
            Dim RadioButtonLabel As String, RadioButtonID As String = Me.ControlID

            If Not ItemIndex Is Nothing Then _
                RadioButtonID = String.Format("{0}_{1}", Me.ControlID, ItemIndex)
            RadioButtonLabel = String.Format("<label for=""{0}"">{1}</label>", RadioButtonID, Me.Text)

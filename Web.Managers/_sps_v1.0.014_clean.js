...
SWCProcs.prototype.postForm = function(AssemblyInfo)
{
    document.getElementById("PostBackInformation").value = AssemblyInfo;
    document.forms[0].submit();
};

SWCProcs.prototype.createHttpRequest = function()
{
...
SWCProcs.prototype.doRequest = function(UpdateLocation, AssemblyInfo)
{
    ...
    if (this.httprequests[httprequestIndex] != null)
    {
        ...
        {
            this.httprequests[httprequestIndex].onreadystatechange = function() { __swcProcs.processstate(currentUpdateLocation, nextUpdateLocations, AssemblyInfo, httprequestIndex); };
...
SWCProcs.prototype.processstate = function(divID, nextDivIDs, AssemblyInfo, httprequestindex)
{
...
SWCProcs.prototype.findObjectById = function(searchObject, searchID)
{
...
SWCProcs.prototype.compileScriptTags = function(element)
{
    var returnValue = "";

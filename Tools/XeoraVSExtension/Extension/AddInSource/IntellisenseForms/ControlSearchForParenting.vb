Namespace XeoraCube.VSAddIn.Forms
    Public Class ControlSearchForParenting
        ...
        Public Overrides Sub HandleResult()
            MyBase.HandleResultDelegate.BeginInvoke(MyBase.WindowHandler, Me.DialogResult = System.Windows.Forms.DialogResult.OK, Me.BeginningOffset, Me.CurrentSelection, Globals.ISTypes.ControlSearchForParenting, Me.AcceptChar, Me.UseCloseChar, New Object() {Me.ControlType, Me.ControlID}, New AsyncCallback(Sub(aR As IAsyncResult)
                                                                                                                                                                                                                                                                                                                         Try

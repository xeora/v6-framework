Namespace Xeora.VSAddIn.Forms
    Public Class TypeSearch
        ...
        Public Overrides Sub HandleResult()
            MyBase.HandleResultDelegate.BeginInvoke(MyBase.WindowHandler, Me.DialogResult = System.Windows.Forms.DialogResult.OK, Me.BeginningOffset, Me.CurrentSelection, Globals.ISTypes.TypeSearch, Me.AcceptChar, Me.UseCloseChar, New Object() {Me.ControlTypeString}, New AsyncCallback(Sub(aR As IAsyncResult)
                                                                                                                                                                                                                                                                                                  Try

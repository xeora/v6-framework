Namespace XeoraCube.VSAddIn.Forms
    Public Class ControlSearch
        ...
        Public Overrides Sub HandleResult()
            MyBase.HandleResultDelegate.BeginInvoke(MyBase.WindowHandler, Me.DialogResult = Windows.Forms.DialogResult.OK, Me.BeginningOffset, Me.CurrentSelection, Globals.ISTypes.ControlSearch, Me.AcceptChar, Me.UseCloseChar, New Object() {Me.ControlType, Me.ControlID}, New AsyncCallback(Sub(aR As IAsyncResult) CType(aR.AsyncState, AddInControl.HandleResultDelegate).EndInvoke(Nothing, aR)), MyBase.HandleResultDelegate)
        End Sub

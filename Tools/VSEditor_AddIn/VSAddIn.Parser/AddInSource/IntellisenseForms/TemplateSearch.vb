Namespace XeoraCube.VSAddIn.Forms
    Public Class TemplateSearch
        ...
        Public Overrides Sub HandleResult()
            MyBase.HandleResultDelegate.BeginInvoke(MyBase.WindowHandler, Me.DialogResult = Windows.Forms.DialogResult.OK, Me.BeginningOffset, Me.CurrentSelection, Globals.ISTypes.TemplateSearch, Me.AcceptChar, Me.UseCloseChar, New Object() {Me.TemplateID}, New AsyncCallback(Sub(aR As IAsyncResult) CType(aR.AsyncState, AddInControl.HandleResultDelegate).EndInvoke(Nothing, aR)), MyBase.HandleResultDelegate)
        End Sub

Namespace XeoraCube.VSAddIn.Forms
    Public Class FunctionSearch
        ...
        Public Overrides Sub HandleResult()
            MyBase.HandleResultDelegate.BeginInvoke(MyBase.WindowHandler, Me.DialogResult = Windows.Forms.DialogResult.OK, Me.BeginningOffset, Me.CurrentSelection, Globals.ISTypes.FunctionSearch, Me.AcceptChar, Me.UseCloseChar, New Object() {Me.FunctionID, Me.FunctionParameterNames}, New AsyncCallback(Sub(aR As IAsyncResult) CType(aR.AsyncState, AddInControl.HandleResultDelegate).EndInvoke(Nothing, aR)), MyBase.HandleResultDelegate)
        End Sub

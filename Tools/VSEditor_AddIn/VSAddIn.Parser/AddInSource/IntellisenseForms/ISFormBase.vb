Namespace XeoraCube.VSAddIn.Forms
    Public MustInherit Class ISFormBase
        Public Delegate Sub EnteredTextDelegate(ByRef owner As IWin32Window, ByVal CurrentText As String, ByVal BeginningOffset As Integer, ByVal Selection As EnvDTE.TextSelection, ByVal RaiseIntelliSense As Boolean)
        ...
        Private Sub SearchCacheChanges()
            If Me._BeginningOffset < Me._CurrentSelection.ActivePoint.LineCharOffset Then
                Dim ChangeDifference As Integer = _
        ...
        Public Shadows Function ShowDialog(ByRef owner As IWin32Window) As DialogResult
            ...
            Dim DialogThread As System.Threading.Thread = _
        ...
        Protected Sub Sort()
            Me.lwControls.ListViewItemSorter = New ControlIDSorter
        ...
        Private Class ControlIDSorter
            ...
            Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements System.Collections.IComparer.Compare
                ...
                Return String.Compare(lItem1.SubItems.Item(1).Text, lItem2.SubItems.Item(1).Text)
            End Function
        End Class
        ...
        Protected Overridable Sub _CancelSelection()
            ...
            Me.Close(Windows.Forms.DialogResult.Cancel)
        End Sub

        Public Shadows Sub Close(ByVal DialogResult As Windows.Forms.DialogResult)
        ...
        Private Sub IntellisenseForm_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
            If Me.DialogResult = Windows.Forms.DialogResult.None Then Me._CancelSelection()
        End Sub
        ...
        Private Sub CacheChanged()
            If Not Me._EnteredTextHandler Is Nothing AndAlso _
                Not Me._CurrentCache Is Nothing Then

                Me._EnteredTextHandler.BeginInvoke(Me._WindowHandler, Me._CurrentCache, Me._BeginningOffset, Me._CurrentSelection, Me._RaiseIntelliSense, New AsyncCallback(AddressOf Me.EnteredTextHandlerEnd), Me._EnteredTextHandler)
            End If

            If Not String.IsNullOrEmpty(Me._CurrentCache) Then
                Dim LWItem As ListViewItem = _
                ...
                Else
                    If Me._UnmatchedAutoCompleteCloseLimit > 0 AndAlso _
        ...
        Private Sub EnteredTextHandlerEnd(ByVal aI As IAsyncResult)
            CType(aI.AsyncState, EnteredTextDelegate).EndInvoke(Me._WindowHandler, aI)
        End Sub
        ...
        Private Sub PrepareVisibleSize(ByVal AccordingToSelected As Boolean)
            ...
            If AccordingToSelected Then
                If Me.lwControls.SelectedItems.Count > 0 Then
                    ...
                    Dim Size As System.Drawing.SizeF = _
        ...
        Private Sub ISFormBase_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
            ...
            If Me.lwControls.Items.Count > 0 AndAlso _
